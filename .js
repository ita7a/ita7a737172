...
$("a.label.label-primary.fl > img.fl").replaceWith('<img src="/sico/z1dmr9lrbq10.gif" class="fl" style="margin-Right: 2px; width: 70px;">');$(`<img src="https:/sico/z1dk1qo9co10.jpg" class="fr" style="width:100%;margin-top: 1px;">
default">⠀الإشتراكات⠀</a>
...
<font color="#78939C"> اداره  الموقع </font> </BR>
 ...
 </BR> للشكاوي والاقتراحات </BR>
<font color="#BF1D6E">Snap:Muh.911</font></BR>     
`).insertBefore('.nav-tabs');$("<a href=' ' target='_blank' class='fr btn btn-info fa fa-heart'>...... iTa7a.......</a>").insertAfter('.loginstat');$(".label-primary").css("border-radius","24px 24px 24px 24px")
$(`<link href="https://fonts.googleapis.com/css?family=Changa" rel="stylesheet">
<marquee direction="right" width="65%" direction="right" style="margin-bottom: -7px;font-family: 'Changa', sans-serif; height: 20px;color:#FFF7AB;" onmouseover="this.stop()" onmouseout="this.start()" scrolldelay="0" scrollamount="5">🌸مرحبا بكم نتمنى لكم قضاء أجمل الاوقات معنا .. ولمعاوده زيارتنا الكتابه في محركات البحث قوقل شات التحليـه
</marquee></font></b></td>
`).insertBefore('span.s1.fa.fa-user.label.badgex.label-as-badge.label-success');$("div#tlogins button.btn.btn-primary").click(function(){var myVar=setInterval(function(){var usmsgw=$(".pmsgc").length;if(usmsgw>0){$(`<div class="uzr fl corner borderg mm" style="border-radius:5px;margin-bottom:-2px;width:99.5%;padding:0px; background-color:#F7E7E7;">
...
<img class="fl u-ico" alt="" src="/sico/1572095805304.jpg">
...
('a[href="/sico/1558730372080.png"]').removeAttr('href');$(`<link rel="stylesheet" type="text/css" href="//www.fontstatic.com/f=jazeera-light,jazeera"><link rel="stylesheet" href="assl.css">
